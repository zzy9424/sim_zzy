...
def single_agent_args():
    custom_parameters = [
        ...
        {"name": "--task", "type": str, "default": "SafetyRacecarGoal0-v0", "help": "The task to run"},
        ...
        {"name": "--total-steps", "type": int, "default": 20000000, "help": "Total timesteps of the experiments"},
