...
def register_minigrid_envs():
    ...
    register(
        id="MiniGrid-LavaCrossingS7N1-v0",
        entry_point="minigrid.envs:CrossingEnv",
        kwargs={"size": 7, "num_crossings": 1},
    )
    register(
    ...
    # ----------------------------------------
    register(
        id="MiniGrid-SimpleCrossingS5N1-v0",
        entry_point="minigrid.envs:CrossingEnv",
        kwargs={"size": 5, "num_crossings": 1, "obstacle_type": Wall},
    )

    register(
        id="MiniGrid-SimpleCrossingS7N1-v0",
        entry_point="minigrid.envs:CrossingEnv",
        kwargs={"size": 7, "num_crossings": 1, "obstacle_type": Wall},
    )
    ...
    register(
        id="MiniGrid-Door-5x5-v0",
        entry_point="minigrid.envs:DoorEnv",
        kwargs={"size": 5},
    )
    register(
        id="MiniGrid-Door-6x6-v0",
        entry_point="minigrid.envs:DoorEnv",
        kwargs={"size": 6},
    )
    register(
        id="MiniGrid-Door-8x8-v0",
        entry_point="minigrid.envs:DoorEnv",
        kwargs={"size": 8},
    )
    ...
    register(
        id="MiniGrid-SimplePutNear-v0",
        entry_point="minigrid.envs:SimplePutNearEnv",
    )
    ...
    register(
        id="MiniGrid-TwoDoors-v0",
        entry_point="minigrid.envs:TwoDoorEnv",
    )
